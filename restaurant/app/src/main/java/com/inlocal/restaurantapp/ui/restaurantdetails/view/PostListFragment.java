...
public class PostListFragment extends BaseFragment<FragmentPostListBinding> implements ImagesAdapter.ImagesCallback, StoryImagesAdapter.StoryImagesCallback, CustomerPostImagesAdapter.ImagesCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvNoRecord.setText("Fragment Post");
    }
